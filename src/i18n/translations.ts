...
"promptPreviewModal.loading": dict("Loading prompts…", "Carregando prompts…", "Cargando prompts…"),
...
"usageDetailsModal.unknownPricing": dict("Unknown pricing", "Preço desconhecido", "Precio desconocido"),
...
"subagentsModal.title": dict("Subagents — {title}", "Subagentes — {title}", "Subagentes — {title}"),
...
"subagentsModal.unknownPricing": dict("Unknown pricing", "Preço desconhecido", "Precio desconocido"),
...
"subagentsModal.loading": dict("Loading subagents…", "Carregando subagentes…", "Cargando subagentes…"),
...
"searchBar.clearLabel": dict(
  "Clear search",
  "Limpar busca",
  "Limpiar búsqueda",
),

"worktreeFilter.label": dict(
  "Worktrees only",
  "Somente worktrees",
  "Solo worktrees",
),
...
"projectFilter.allProjects": dict(
  "All projects",
  "Todos os projetos",
  "Todos los proyectos",
),

"dateRangeFilter.fromLabel": dict(
  "Updated from",
  "Atualizado a partir de",
  "Actualizado desde",
),
"dateRangeFilter.toLabel": dict(
  "Updated to",
  "Atualizado até",
  "Actualizado hasta",
),
"dateRangeFilter.to": dict(
  "to",
  "até",
  "hasta",
),

"pagination.previousLabel": dict(
  "Previous page",
  "Página anterior",
  "Página anterior",
),
"pagination.nextLabel": dict(
  "Next page",
  "Próxima página",
  "Página siguiente",
),
...
"perPageSelect.ariaLabel": dict(
  "Sessions per page",
  "Sessões por página",
  "Sesiones por página",
),
"perPageSelect.all": dict(
  "All",
  "Todas",
  "Todas",
),
"perPageSelect.perPage": dict(
  "{count} / page",
  "{count} / página",
  "{count} / página",
),
...
"sessionsPage.clearSelection": dict(
  "Clear",
  "Limpar",
  "Limpiar",
),
...
"sessionsPage.refresh": dict(
  "Refresh sessions",
  "Atualizar sessões",
  "Actualizar sesiones",
),
"sessionsPage.delete": dict(
  "Delete",
  "Excluir",
  "Eliminar",
),
"sessionsPage.cancel": dict(
  "Cancel",
  "Cancelar",
  "Cancelar",
),
"sessionsPage.deleteConfirm.title": dict(
  "Delete session",
  "Excluir sessão",
  "Eliminar sesión",
),
...
"sessionCard.deleteButton": dict(
  "Delete",
  "Excluir",
  "Eliminar",
),
"sessionCard.cancelButton": dict(
  "Cancel",
  "Cancelar",
  "Cancelar",
),
"sessionCard.checkbox.select": dict(
  "Select session",
  "Selecionar sessão",
  "Seleccionar sesión",
),
...
"sessionCard.status.activeLabel": dict(
  "Active session",
  "Sessão ativa",
  "Sesión activa",
),
"sessionCard.status.inactiveLabel": dict(
  "Inactive session",
  "Sessão inativa",
  "Sesión inactiva",
),
...
"sessionCard.subagentCount.none": dict(
  "No subagents",
  "Nenhum subagente",
  "Sin subagentes",
),
"sessionCard.updatedPrefix": dict(
  "Updated",
  "Atualizada",
  "Actualizada",
),
...
"sessionCard.insightsAriaLabel": dict(
  "View insights",
  "Ver insights",
  "Ver insights",
),
...
"sessionCard.usageAriaLabel": dict(
  "View usage and cost",
  "Ver uso e custo",
  "Ver uso y costo",
),
...
"sessionCard.previewAriaLabel": dict(
  "Preview prompts",
  "Ver prompts",
...
"cleanupModal.title": dict(
  "Cleanup",
  "Limpeza",
  "Limpieza",
),
"cleanupModal.close": dict(
  "Close",
  "Fechar",
  "Cerrar",
),
"cleanupModal.howItWorks.label": dict(
  "How it works:",
  "Como funciona:",
  "Cómo funciona:",
),
...
"newTaskModal.cancel": dict(
  "Cancel",
  "Cancelar",
  "Cancelar",
),
"newTaskModal.clear": dict(
  "Clear",
  "Limpar",
  "Limpiar",
),
...
"newTaskModal.jira.checkAgain": dict(
  "Check again",
  "Verificar novamente",
  "Verificar de nuevo",
),
...
"newTaskModal.projectLabel": dict(
  "Project (folder)",
  "Projeto (pasta)",
  "Proyecto (carpeta)",
),
...
"newTaskModal.promptLabel": dict(
  "Prompt",
  "Prompt",
  "Prompt",
),
"newTaskModal.saving": dict(
  "Saving…",
  "Salvando…",
  "Guardando…",
),
...
"newTaskModal.finalPromptLabel": dict(
  "Final prompt:",
  "Prompt final:",
  "Prompt final:",
),
"newTaskModal.baseBranchLabel": dict(
  "Base branch",
  "Branch base",
  "Rama base",
),
"newTaskModal.branchTypeLabel": dict(
  "Branch type",
  "Tipo de branch",
  "Tipo de rama",
),
"newTaskModal.otherBranchType": dict(
  "Other",
  "Outro",
  "Otro",
),
...
"newTaskModal.branchNameLabel": dict(
  "Branch name",
  "Nome da branch",
  "Nombre de la rama",
),
"newTaskModal.branchPreview": dict(
  "Preview:",
  "Pré-visualização:",
  "Vista previa:",
),
...
"newTaskModal.progressLabel": dict(
  "Progress:",
  "Progresso:",
  "Progreso:",
),
...
"newTaskModal.explain.basePlaceholder": dict(
  "(base branch)",
  "(branch base)",
  "(rama base)",
),
...
"newTaskModal.explain.launch.and": dict(
  "and starts",
  "e inicia o",
  "y ejecuta",
),
...
"useSessions.nicknameSaved": dict(
  "Nickname saved.",
  "Apelido salvo.",
  "Se guardó el apodo.",
),
...
"updateButton.label": dict(
  "Update",
  "Atualizar",
  "Actualizar",
),
"usageLimitsBadge.compact.session": dict(
  "5h",
  "5h",
  "5h",
),
"usageLimitsBadge.compact.weeklyAll": dict(
  "7d",
  "7d",
  "7d",
),
"usageLimitsBadge.full.session": dict(
  "Session (5h)",
  "Sessão (5h)",
  "Sesión (5h)",
),
"usageLimitsBadge.full.weeklyAll": dict(
  "Weekly",
  "Semanal",
  "Semanal",
),
"usageLimitsBadge.full.weeklyOpus": dict(
  "Weekly (Opus)",
  "Semanal (Opus)",
  "Semanal (Opus)",
),
...
"usageLimitsBadge.lessThanOneMin": dict(
  "less than 1min",
  "menos de 1min",
  "menos de 1min",
),
...
"worktreeToRootModal.title": dict(
  "Worktree → root",
  "Worktree → raiz",
  "Worktree → raíz",
),
